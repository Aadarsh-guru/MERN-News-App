...
const PrivacyPolicy = () => {
    return (
        <Layout title={'Privacy-Policy - Inshorts'} >
            <Container>
                <Title>
                    Privacy Policy
                </Title>
                <Description>
                    <Typography>At inshorts clone, accessible from aadarshguru.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by inshorts clone and how we use it.</Typography>
                    ...
                    <Typography>The personal information that you are asked to provide, and the reasons why you are asked to provide it, will be made clear to you at the point we ask you to provide your personal information.</Typography>
                    ...
                    <Typography>When you register for an Account, we may ask for your contact information, including items such as name, company name, address, email address, and telephone number.</Typography>
                    ...
                    <Typography>Some of advertisers on our site may use cookies and web beacons. Our advertising partners are listed below. Each of our advertising partners has their own Privacy Policy for their policies on user data. For easier access, we hyperlinked to their Privacy Policies below.</Typography>

                    <ul>
                        <li>
                            <Typography>Google</Typography>
                            <Typography><a href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a></Typography>
                        </li>
                    </ul>

                    <h2>Advertising Partners Privacy Policies</h2>

                    <Typography>You may consult this list to find the Privacy Policy for each of the advertising partners of inshorts clone.</Typography>

                    <Typography>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on inshorts clone, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</Typography>

                    <Typography>Note that inshorts clone has no access to or control over these cookies that are used by third-party advertisers.</Typography>
                    ...
                    <Typography>Our Privacy Policy was created with the help of the <a href="https://www.privacypolicygenerator.info">Privacy Policy Generator</a>.</Typography>

                    <h2>Contact Us</h2>

                    <Typography>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us.</Typography>                   Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ut quaerat exercitationem nobis esse nemo unde vero nulla debitis officiis blanditiis mollitia consequuntur, ab sed minus consequatur velit inventore veritatis enim.
                </Description>
                <Message>
                    Thank You!
                </Message>
